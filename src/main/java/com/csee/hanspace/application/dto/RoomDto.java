...
public class RoomDto {
    ...
    public CreateRoomResponse createRoomResponse() {
        return new CreateRoomResponse(roomId, site.getId(), roomName, capacity, description, startTime, endTime, available, image);
    }

    public UpdateRoomResponse updateRoomResponse() {
        return new UpdateRoomResponse(roomId, site.getId(), roomName, capacity, description, startTime, endTime, available, image);
    }
